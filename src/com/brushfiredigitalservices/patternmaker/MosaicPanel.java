...
public class MosaicPanel extends JPanel {
   ...
   //------------------ private instance variables --------------------
	...
	private static final int DEFAULT_ROWS = 42;
	private static final int DEFAULT_COLS = 42;

	private static final int DEF_PREF_SQR_WIDTH = 42;
	private static final int DEF_PREF_SQR_HEIGHT = 42;
    ...
    */
   public MosaicPanel() {
      this(DEFAULT_ROWS, DEFAULT_COLS, DEF_PREF_SQR_WIDTH, DEF_PREF_SQR_HEIGHT);
   }
